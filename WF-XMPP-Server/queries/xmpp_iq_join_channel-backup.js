    ...
    Profile.findOne({username: client.jid.user}, function(err, profile_db) {
    		...
    		join_channel = ltx.parse(
    			...
    			"<character nick='"+profile_db.nickname+"' gender='"+profile_db.gender+"' height='"+profile_db.height+"' fatness='0' head='"+profile_db.head+"' current_class='"+profile_db.current_class+"' experience='100' pvp_rating_points='"+profile_db.pvp_rating_points+"' banner_badge='"+profile_db.banner_badge+"' banner_mark='"+profile_db.banner_mark+"' banner_stripe='"+profile_db.banner_stripe+"' game_money='"+profile_db.game_money+"' cry_money='"+profile_db.cry_money+"' crown_money='"+profile_db.crown_money+"'>"+
                    ...
                    // Mostra o item liberado
                    //"<unlocked_item id='32'/>"+

                    // Global chat
    				"<chat_channels>"+
    					"<chat channel='0' channel_id='global.main_pve_6' service_id='conference.warface'/>"+
    				"</chat_channels>"+
    				
    				// Progression
    				"<profile_progression_state profile_id='"+profile_db.profileid+"' mission_unlocked='none,trainingmission,easymission,normalmission,hardmission,survivalmission,zombieeasy,zombienormal,campaignsections,campaignsection1,campaignsection2,campaignsection3,volcanoeasy,volcanonormal,volcanohard,all' tutorial_unlocked='7' tutorial_passed='7' class_unlocked='29' />"+
    				
                    "<login_bonus current_streak='0' current_reward='0'/>"+
                    
    			    "<variables>"+
                        "<item key='max_xp_boost_effect' value='3'/>"+
                        "<item key='max_vp_boost_effect' value='3'/>"+
                        "<item key='max_gm_boost_effect' value='3'/>"+
                        "<item key='max_ic_boost_effect' value='1'/>"+
                        "<item key='randombox.offers_count' value='5'/>"+
                        "<item key='url.charge_account' value='http://game-amazing.ga/warface/'/>"+
                        "<item key='url.online_help' value='http://game-amazing.ga/warface/'/>"+
                        "<item key='dailycompetition.rewardPlayersCount' value='10000'/>"+
                        ...
                        "<item key='min_online_users' value='2'/>"+
                        ...
                        "<item key='cvar:ui_lobby_rating_tab_min_rank' value='13'/>"+
                        ...
                        "<item key='cvar:cl_quickplay_gamemode_based' value='1'/>"+
                        ...
                        "<item key='cvar:cl_payment_enabled' value='1'/>"+
                    "</variables>"+
